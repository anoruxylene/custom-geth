...
import (
	...
	"custom-geth/internal/goethereum/trie"
)
...
func testSyncProgress(t *testing.T, protocol uint, mode SyncMode) {
	...
	checkProgress(t, tester.downloader, "pristine", goethereum.SyncProgress{})
	...
	<-starting
	checkProgress(t, tester.downloader, "initial", goethereum.SyncProgress{
	...
	<-starting
	checkProgress(t, tester.downloader, "completing", goethereum.SyncProgress{
	...
	progress <- struct{}{}
	pending.Wait()
	checkProgress(t, tester.downloader, "final", goethereum.SyncProgress{
		StartingBlock: uint64(len(chain.blocks)/2 - 1),
...
func checkProgress(t *testing.T, d *Downloader, stage string, want goethereum.SyncProgress) {
	// Mark this method as a helper to report errors at callsite, not in here
	t.Helper()
...
func testForkedSyncProgress(t *testing.T, protocol uint, mode SyncMode) {
	...
	<-starting
	checkProgress(t, tester.downloader, "forking", goethereum.SyncProgress{
