...
func (ec *Client) CreateAccessList(ctx context.Context, msg goethereum.CallMsg) (*types.AccessList, uint64, string, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg goethereum.CallMsg, blockNumber *big.Int, overrides *map[common.Address]OverrideAccount) ([]byte, error) {
...
func toCallArg(msg goethereum.CallMsg) interface{} {
