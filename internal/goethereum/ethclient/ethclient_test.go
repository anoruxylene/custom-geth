...
var (
	_ = goethereum.ChainReader(&Client{})
	_ = goethereum.TransactionReader(&Client{})
	_ = goethereum.ChainStateReader(&Client{})
	_ = goethereum.ChainSyncReader(&Client{})
	_ = goethereum.ContractCaller(&Client{})
	_ = goethereum.GasEstimator(&Client{})
	_ = goethereum.GasPricer(&Client{})
	_ = goethereum.LogFilterer(&Client{})
	_ = goethereum.PendingStateReader(&Client{})
	// _ = ethereum.PendingStateEventer(&Client{})
	_ = goethereum.PendingContractCaller(&Client{})
)
...
func testTransactionInBlockInterrupted(t *testing.T, client *rpc.Client) {
	...
	if err == nil || err == goethereum.NotFound {
		t.Fatal("error should not be nil/notfound")
	}

	// Test tx in block not found.
	if _, err := ec.TransactionInBlock(context.Background(), block.Hash(), 20); err != goethereum.NotFound {
