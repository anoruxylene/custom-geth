...
import (
	_ "custom-geth/internal/goeth/crypto/secp256k1/libsecp256k1/include"
	_ "custom-geth/internal/goeth/crypto/secp256k1/libsecp256k1/src"
	_ "custom-geth/internal/goeth/crypto/secp256k1/libsecp256k1/src/modules/recovery"
)
