...
func (ec *Client) CreateAccessList(ctx context.Context, msg goeth.CallMsg) (*types.AccessList, uint64, string, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg goeth.CallMsg, blockNumber *big.Int, overrides *map[common.Address]OverrideAccount) ([]byte, error) {
...
func toCallArg(msg goeth.CallMsg) interface{} {
